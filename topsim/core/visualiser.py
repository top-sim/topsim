...
class Visualiser:
    ...
    def make_document(self, doc):
        ...
        p.line(x='time', y='running', legend_label='Running tasks', alpha=0.2,
               line_width=3, color='navy', source=plotdata)
        p.line(x='time', y='finished', legend_label='Finished tasks', alpha=0.8,
               line_width=2, color='orange', source=plotdata)
        ...
        data_table = DataTable(source=tablesource, columns=columns, width=600,
                               height=280)
